...
import { ESTADOS_TAREA, EstadoTarea, Tarea } from '../../infrastructure/models/TareaModels';

const tareaService = new TareaServiceImpl();
const proyectoService = new ProyectoServiceImpl();

const isValidEstado = (estado: string): estado is EstadoTarea => {
...
export class TareaController {
    ...
    async updateEstadoTarea(req: Request, res: Response) {
        try {
